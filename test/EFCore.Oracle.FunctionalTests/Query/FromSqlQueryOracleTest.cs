...
{
    public class FromSqlQueryOracleTest : FromSqlQueryTestBase<NorthwindQueryOracleFixture>
    {
        public FromSqlQueryOracleTest(NorthwindQueryOracleFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {

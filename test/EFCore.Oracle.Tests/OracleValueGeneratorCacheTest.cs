...
{
    public class OracleValueGeneratorCacheTest
    {
        [Fact]
        public void Uses_single_generator_per_property()
        {
            ...
            var cache = OracleTestHelpers.Instance.CreateContextServices(model).GetRequiredService<IOracleValueGeneratorCache>();
        ...
        public void Block_size_is_obtained_from_default_sequence()
        {
            ...
            var cache = new OracleValueGeneratorCache(new ValueGeneratorCacheDependencies());
        ...
        public void Block_size_is_obtained_from_named_sequence()
        {
            var property = CreateConventionModelBuilder()
                .Entity<Robot>()
                .Property(e => e.Id)
                .ForOracleUseSequenceHiLo("DaneelOlivaw")
                .Metadata;
        ...
        public void Schema_qualified_sequence_name_is_obtained_from_named_sequence()
        {
            var property = CreateConventionModelBuilder()
                .Entity<Robot>()
                .Property(e => e.Id)
                .ForOracleUseSequenceHiLo("DaneelOlivaw", "R")
                .Metadata;
        ...
        protected virtual ModelBuilder CreateConventionModelBuilder() => OracleTestHelpers.Instance.CreateConventionBuilder();

        private static Property CreateProperty()
        {
            var entityType = new Model().AddEntityType("MyType");
            var property = entityType.AddProperty("MyProperty", typeof(string));
            entityType.Oracle().TableName = "MyTable";
        ...
        private static IModel CreateModel()
        {
            ...
            modelBuilder.Entity<Led>(b =>
                {
                    b.Property(e => e.Zeppelin).ForOracleUseSequenceHiLo("Heaven");
                    b.Property(e => e.Stairway).ForOracleUseSequenceHiLo("Heaven");
                    b.Property(e => e.WholeLotta).ForOracleUseSequenceHiLo("Rosie");
                });
